...
<div>
		...
		<script src="style/icheck.js"></script>
			<script>
		...
		<!--Fin Pour le pege de recherche -->


		<?php else: ?>

		<script type="text/javascript" src="global/accueil/js/vendors/jquery-3.3.1.min.js"></script>
		<script type="text/javascript" src="global/accueil/js/vendors/bootstrap.js"></script>
		<script type="text/javascript" src="global/accueil/js/main.js"></script>
