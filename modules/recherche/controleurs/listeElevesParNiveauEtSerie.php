...
if (isset($_SESSION['auth'])){
	...
	if (isset($_POST['liste'])) {
		...
		if( empty($_POST['serie'])){ // Vérifie si la serie n'est pas renseignée          
            $errors['serie'] = "Vous devez renseigner la 'nom' de la Série";
        }
	...
	include CHEMIN_VUE.'listeElevesParNiveauEtSerie.php';
