...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        LISTES DES ELEVES PAR NIVEAU ET SERIE 
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Liste des élèves d'une classe par niveau et série</li>
      </ol>
    </section>
        ...
        <div class="col-md-3 col-lg-8 col-xs-8 col-sm-3">
          ...
          <select id="serie" name='serie' class="form-control select2">
                ...
                <?php 
                  ...
                  $req = $pdo->prepare("SELECT DISTINCT serie FROM serie WHERE ecole='".$ecole."' order by serie asc ");
                  $req->execute();
    ...
    <!-- /row -->
     <br><br>
          ...
          <?php 
            ...
            if (!empty($_POST['niveau']) && !empty($_POST['serie']) && !empty($_POST['anneeScolaire']) ) {
          ?>
      <div id='section2Aimprimer' style='page-break-before:always'>
        <div class="row">
          <div class="col-md-12">
            <h2 colspan="9" style="text-align: center;"> <em>Liste des élèves des classes de <b><?= $_POST['niveau']."
            ".$_POST['serie']; ?></b> pour l'année scolaire <b><?= $anneeScolaire ?></b></em> </h2>
          </div>
        </div>
           ...
           <tbody>
            <?php
              ...
              $req = $pdo->prepare("SELECT * FROM etreeleve, eleve WHERE etreeleve.eleve=eleve.matricule
                ...
                AND etreeleve.serie='".$_POST['serie']."'
