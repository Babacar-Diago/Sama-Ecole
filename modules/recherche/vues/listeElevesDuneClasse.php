...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        LISTES DES ELEVES D'UNE CLASSE 
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Liste des élèves d'une classe</li>
      </ol>
    </section>
        ...
        <div class="col-md-3 col-lg-8 col-xs-8 col-sm-3">
          ...
          <select id="classe" name='classe' class="form-control select2">
                ...
                <?php 
                  ...
                  $req = $pdo->prepare("SELECT DISTINCT nom FROM classe WHERE ecole='".$ecole."' AND idAnneeScolaire='".$idActuelAnScol."' order by nom asc ");
                  $req->execute();
    ...
    <!-- /row -->
     <br><br>
      ...
      <div id='section2Aimprimer' style='page-break-before:always'>
        <div class="row">
          <div class="col-md-12">
            <h2 colspan="9" style="text-align: center;"> <em>Liste des élèves de la classe <b><?= $_POST['classe'] ?></b> pour l'année scolaire <b><?= $anneeScolaire ?></b></em> </h2>
          </div>
        </div>
          ...
          <table class="table table-bordered table-striped">
           <thead>
            <tr>
              ...
              <th><center>Classe doublée ?</center></th>
            </tr>
           </thead>
           <tbody>
            <?php
              ...
              if ($req){
                  ...
                  $i = ++$i; 
                    ...
                    echo "<tr>";
                      ...
                      echo "<td align='center'>".$value['classeDoublee']."</td>";
                    echo "</tr>";
                  }
            ?>
           </tbody>
            ...
            <button onClick="imprimer('section2Aimprimer')" class="btn btn-primary"><i class="fa fa-print"></i> Imprimer la liste</button>  <br>
        <?php  
            } 
          }
        ?>             
