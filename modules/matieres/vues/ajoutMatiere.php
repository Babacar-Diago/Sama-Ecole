...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ajout d'une matière dans la base de donnée
      </h1>
      <ol class="breadcrumb">
    		...
    		<form action="" method="post" role="form" class="box-body">
    			<p>
    				<div class="col-md-8 col-lg-8 col-xs-12 col-sm-8">
    					<label> Matiere : </label>     
    					<input type="text" class="form-control" name="matiere" maxlength="20" /> 
    				</div>
    				<div class="col-md-8 col-lg-8 col-xs-12 col-sm-8">
    					<br><input type="submit" class="btn btn-primary" value="AJOUTER" name="ajout" />
    				</div>				
    			</p>
    		</form>
	   </div>
